...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("ice cream", "mountains", chef) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["eggs", "chocolate", "flour", "sugar", "butter"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      # expect { brownie.eat(200)}.to raise_error("not enought left!") #why does this not work?
